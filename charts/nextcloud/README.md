...
![Version: 6.5.2](https://img.shields.io/badge/Version-6.5.2-informational?style=flat-square) ![AppVersion: 30.0.4](https://img.shields.io/badge/AppVersion-30.0.4-informational?style=flat-square)
...
| collabora.ingress.tls | list | `[]` |   - secretName: collabora-ingress-tls    hosts:      - collabora.domain |
...
| imaginary.livenessProbe.enabled | bool | `true` |  |
| imaginary.livenessProbe.failureThreshold | int | `3` |  |
| imaginary.livenessProbe.periodSeconds | int | `10` |  |
| imaginary.livenessProbe.successThreshold | int | `1` |  |
| imaginary.livenessProbe.timeoutSeconds | int | `1` |  |
...
| imaginary.readinessProbe.enabled | bool | `true` |  |
| imaginary.readinessProbe.failureThreshold | int | `3` |  |
| imaginary.readinessProbe.periodSeconds | int | `10` |  |
| imaginary.readinessProbe.successThreshold | int | `1` |  |
| imaginary.readinessProbe.timeoutSeconds | int | `1` |  |
...
| metrics.image.pullSecrets | string | `nil` |  |
