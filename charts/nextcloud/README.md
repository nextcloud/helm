...
| `cronjob.commandCrondSidecar`                               | The command the cronjob container executes                                                          | `/cron.sh`                                             |
...
| `cronjob.useCronJobInsteadOfCrond`                          | Whether to use a cronjob instead of crond                                                           | `false`                                                |
...
| `cronjob.labels`                                            | An array of service labels                                                                          | `nil`                                                  |
| `cronjob.backoffLimit`                                      | The number of retries before marking a job as failed                                                | `1`                                                    |
| `cronjob.annotations`                                       | An array of service annotations                                                                     | `nil`                                                  |
| `cronjob.commandCronJob`                                    | The command the cronjob executes                                                                    | `["php", "-f", "/var/www/html/cron.php"] -- --verbose` |
