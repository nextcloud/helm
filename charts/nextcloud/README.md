...
| `nextcloud.defaultConfigs.helm-metrics\.config\.php`        | Applies `nextcloud.openmetrics.allowedClients` to `openmetrics_allowed_clients`                     | `true`                                                       |
| `nextcloud.defaultConfigs.imaginary\.config\.php`           | Preview configuration for the bundled Imaginary service                                             | `false`                                                      |
